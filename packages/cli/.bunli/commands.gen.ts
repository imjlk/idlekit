...
const metadata: Record<GeneratedNames, GeneratedCommandMeta> = {
  ...
  'compare': {
      ...
      options: {
        ...
        'fast': { type: 'z.coerce.boolean.default', required: true, hasDefault: true, default: false, description: 'Enable fast(log-domain) mode', schema: {"type":"zod","method":"default","args":[{"type":"unknown","raw":{"type":"BooleanLiteral","start":7067,"end":7072,"loc":{"start":{"line":219,"column":44,"index":7067},"end":{"line":219,"column":49,"index":7072}},"value":false}}]}, validator: '(val) => true' },
        ...
        'max-duration': { type: 'z.coerce.number.default', required: true, hasDefault: true, default: 86400, description: 'Max duration for etaToTargetWorth metric simulation', schema: {"type":"zod","method":"default","args":[{"type":"unknown","raw":{"type":"NumericLiteral","start":7317,"end":7322,"loc":{"start":{"line":223,"column":53,"index":7317},"end":{"line":223,"column":58,"index":7322}},"extra":{"rawValue":86400,"raw":"86400"},"value":86400}}]}, validator: '(val) => true' },
  ...
  'ltv': {
      ...
      options: {
        ...
        'strategy': { type: 'strategySchema', required: true, hasDefault: false, description: 'Override strategy id (greedy|planner|scripted)', schema: {"type":"zod","name":"strategySchema"}, validator: '(val) => true' },
        'fast': { type: 'z.coerce.boolean.default', required: true, hasDefault: true, default: false, description: 'Enable fast(log-domain) mode for long horizons', schema: {"type":"zod","method":"default","args":[{"type":"unknown","raw":{"type":"BooleanLiteral","start":5524,"end":5529,"loc":{"start":{"line":162,"column":44,"index":5524},"end":{"line":162,"column":49,"index":5529}},"value":false}}]}, validator: '(val) => true' },
        'seed': { type: 'z.coerce.number.optional', required: false, hasDefault: false, description: 'Deterministic seed passed to ctx.seed', schema: {"type":"zod","method":"optional","args":[]}, validator: '(val) => true' },
  ...
  'report': {
      ...
      options: {
        ...
        'include-growth': { type: 'z.coerce.boolean.default', required: true, hasDefault: true, default: false, description: 'Include growth report', schema: {"type":"zod","method":"default","args":[{"type":"unknown","raw":{"type":"BooleanLiteral","start":1041,"end":1046,"loc":{"start":{"line":34,"column":56,"index":1041},"end":{"line":34,"column":61,"index":1046}},"value":false}}]}, validator: '(val) => true' },
        'include-ux': { type: 'z.coerce.boolean.default', required: true, hasDefault: true, default: false, description: 'Include UX flags', schema: {"type":"zod","method":"default","args":[{"type":"unknown","raw":{"type":"BooleanLiteral","start":1144,"end":1149,"loc":{"start":{"line":35,"column":52,"index":1144},"end":{"line":35,"column":57,"index":1149}},"value":false}}]}, validator: '(val) => true' },
        'out': { type: 'z.string.optional', required: false, hasDefault: false, description: 'Output path', fileType: 'path', schema: {"type":"zod","method":"optional","args":[]}, validator: '(val) => true' },
  ...
  'simulate': {
      ...
      options: {
        ...
        'fast': { type: 'z.coerce.boolean.default', required: true, hasDefault: true, default: false, description: 'Enable fast(log-domain) mode', schema: {"type":"zod","method":"default","args":[{"type":"unknown","raw":{"type":"BooleanLiteral","start":3295,"end":3300,"loc":{"start":{"line":88,"column":44,"index":3295},"end":{"line":88,"column":49,"index":3300}},"value":false}}]}, validator: '(val) => true' },
  ...
  'tune': {
      ...
      options: {
        'tune': { type: 'z.string.min', required: true, hasDefault: false, description: 'TuneSpec file path (.json|.yaml)', min: 1, minLength: 1, fileType: 'file', schema: {"type":"zod","method":"min","args":[{"type":"unknown","raw":{"type":"NumericLiteral","start":5715,"end":5716,"loc":{"start":{"line":177,"column":32,"index":5715},"end":{"line":177,"column":33,"index":5716}},"extra":{"rawValue":1,"raw":"1"},"value":1}}]}, validator: '(val) => true' },
        ...
        'run-id': { type: 'z.string.optional', required: false, hasDefault: false, description: 'Optional run identifier used in output metadata', schema: {"type":"zod","method":"optional","args":[]}, validator: '(val) => true' },
        'regression-tolerance': { type: 'z.coerce.number.default', required: true, hasDefault: true, default: 0, description: 'Allowed score decrease before regression is flagged', schema: {"type":"zod","method":"default","args":[{"type":"unknown","raw":{"type":"NumericLiteral","start":6349,"end":6350,"loc":{"start":{"line":188,"column":61,"index":6349},"end":{"line":188,"column":62,"index":6350}},"extra":{"rawValue":0,"raw":"0"},"value":0}}]}, validator: '(val) => true' },
        'fail-on-regression': { type: 'z.coerce.boolean.default', required: true, hasDefault: true, default: false, description: 'Exit with error when regression is detected', schema: {"type":"zod","method":"default","args":[{"type":"unknown","raw":{"type":"BooleanLiteral","start":6497,"end":6502,"loc":{"start":{"line":191,"column":60,"index":6497},"end":{"line":191,"column":65,"index":6502}},"value":false}}]}, validator: '(val) => true' },
        'out': { type: 'z.string.optional', required: false, hasDefault: false, description: 'Output path', fileType: 'path', schema: {"type":"zod","method":"optional","args":[]}, validator: '(val) => true' },
        'format': { type: 'z.enum.default', required: true, hasDefault: true, default: "json", description: 'Output format', enumValues: ["json","md","csv"], schema: {"type":"zod","method":"default","args":[{"type":"literal","value":"json"}]}, validator: '(val) => true' }
      },
