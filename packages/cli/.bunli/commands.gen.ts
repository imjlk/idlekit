...
const metadata: Record<GeneratedNames, GeneratedCommandMeta> = {
  ...
  'compare': {
      ...
      options: {
        ...
        'fast': { type: 'z.coerce.boolean.default', required: true, hasDefault: true, default: false, description: 'Enable fast(log-domain) mode', schema: {"type":"zod","method":"default","args":[{"type":"unknown","raw":{"type":"BooleanLiteral","start":6095,"end":6100,"loc":{"start":{"line":182,"column":44,"index":6095},"end":{"line":182,"column":49,"index":6100}},"value":false}}]}, validator: '(val) => true' },
        ...
        'max-duration': { type: 'z.coerce.number.default', required: true, hasDefault: true, default: 86400, description: 'Max duration for etaToTargetWorth metric simulation', schema: {"type":"zod","method":"default","args":[{"type":"unknown","raw":{"type":"NumericLiteral","start":6345,"end":6350,"loc":{"start":{"line":186,"column":53,"index":6345},"end":{"line":186,"column":58,"index":6350}},"extra":{"rawValue":86400,"raw":"86400"},"value":86400}}]}, validator: '(val) => true' },
  ...
  'ltv': {
      ...
      options: {
        ...
        'strategy': { type: 'strategySchema', required: true, hasDefault: false, description: 'Override strategy id (greedy|planner|scripted)', schema: {"type":"zod","name":"strategySchema"}, validator: '(val) => true' },
        'fast': { type: 'z.coerce.boolean.default', required: true, hasDefault: true, default: false, description: 'Enable fast(log-domain) mode for long horizons', schema: {"type":"zod","method":"default","args":[{"type":"unknown","raw":{"type":"BooleanLiteral","start":5382,"end":5387,"loc":{"start":{"line":161,"column":44,"index":5382},"end":{"line":161,"column":49,"index":5387}},"value":false}}]}, validator: '(val) => true' },
        'seed': { type: 'z.coerce.number.optional', required: false, hasDefault: false, description: 'Deterministic seed passed to ctx.seed', schema: {"type":"zod","method":"optional","args":[]}, validator: '(val) => true' },
  ...
  'simulate': {
      ...
      options: {
        ...
        'fast': { type: 'z.coerce.boolean.default', required: true, hasDefault: true, default: false, description: 'Enable fast(log-domain) mode', schema: {"type":"zod","method":"default","args":[{"type":"unknown","raw":{"type":"BooleanLiteral","start":3170,"end":3175,"loc":{"start":{"line":82,"column":44,"index":3170},"end":{"line":82,"column":49,"index":3175}},"value":false}}]}, validator: '(val) => true' },
  ...
  'tune': {
      ...
      options: {
        'tune': { type: 'z.string.min', required: true, hasDefault: false, description: 'TuneSpec file path (.json|.yaml)', min: 1, minLength: 1, fileType: 'file', schema: {"type":"zod","method":"min","args":[{"type":"unknown","raw":{"type":"NumericLiteral","start":3214,"end":3215,"loc":{"start":{"line":107,"column":32,"index":3214},"end":{"line":107,"column":33,"index":3215}},"extra":{"rawValue":1,"raw":"1"},"value":1}}]}, validator: '(val) => true' },
        ...
        'run-id': { type: 'z.string.optional', required: false, hasDefault: false, description: 'Optional run identifier used in output metadata', schema: {"type":"zod","method":"optional","args":[]}, validator: '(val) => true' },
        'regression-tolerance': { type: 'z.coerce.number.default', required: true, hasDefault: true, default: 0, description: 'Allowed score decrease before regression is flagged', schema: {"type":"zod","method":"default","args":[{"type":"unknown","raw":{"type":"NumericLiteral","start":3848,"end":3849,"loc":{"start":{"line":118,"column":61,"index":3848},"end":{"line":118,"column":62,"index":3849}},"extra":{"rawValue":0,"raw":"0"},"value":0}}]}, validator: '(val) => true' },
        'fail-on-regression': { type: 'z.coerce.boolean.default', required: true, hasDefault: true, default: false, description: 'Exit with error when regression is detected', schema: {"type":"zod","method":"default","args":[{"type":"unknown","raw":{"type":"BooleanLiteral","start":3996,"end":4001,"loc":{"start":{"line":121,"column":60,"index":3996},"end":{"line":121,"column":65,"index":4001}},"value":false}}]}, validator: '(val) => true' },
        'out': { type: 'z.string.optional', required: false, hasDefault: false, description: 'Output path', fileType: 'path', schema: {"type":"zod","method":"optional","args":[]}, validator: '(val) => true' },
        'format': { type: 'z.enum.default', required: true, hasDefault: true, default: "json", description: 'Output format', enumValues: ["json","md","csv"], schema: {"type":"zod","method":"default","args":[{"type":"literal","value":"json"}]}, validator: '(val) => true' }
      },
